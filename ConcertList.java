...
public class ConcertList extends JFrame {
    ...
    private ConcertSearchSort.SortType currentSortType = ConcertSearchSort.SortType.DATE_ASC;
    ...
    private JPanel createTopBar() {
        ...
        // Sort Dropdown
        String[] sortOptions = {
            ConcertSearchSort.SortType.DATE_ASC.getDisplayName(),
            ConcertSearchSort.SortType.DATE_DESC.getDisplayName(),
            ConcertSearchSort.SortType.PRICE_ASC.getDisplayName(),
            ConcertSearchSort.SortType.PRICE_DESC.getDisplayName(),
            ConcertSearchSort.SortType.NAME_ASC.getDisplayName(),
            ConcertSearchSort.SortType.NAME_DESC.getDisplayName()
        };
        ...
        sortComboBox.setBackground(new Color(80, 15, 15));
        sortComboBox.setForeground(Color.WHITE);
        sortComboBox.addActionListener(e -> {
            currentSortType = ConcertSearchSort.SortType.values()[sortComboBox.getSelectedIndex()];
            performSearch();
        });
        
        centerPanel.add(searchField);
        centerPanel.add(new JLabel("Sort by:"));
        centerPanel.add(sortComboBox);
    ...
    private void loadConcerts() {
        ...
        // Get all concerts and apply sorting
        JSONArray concerts = ConcertSearchSort.getAllConcertsSorted(currentSortType);
    ...
    private void performSearch() {
        ...
        concertGridPanel.removeAll();
        // Use new search and sort functionality
        JSONArray concerts = ConcertSearchSort.searchAndSort(keyword, currentSortType);
