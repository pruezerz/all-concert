...
public class SeatSelection extends JFrame {
    ...
    public SeatSelection(int userId, String username, JSONObject concert) {
        ...
        // Top Bar
        mainPanel.add(createSimpleTopBar(), BorderLayout.NORTH);
    ...
    private JPanel createSimpleTopBar() {
        ...
        leftPanel.add(UIUtils.createLogo());
    ...
    private JButton createZoneButton(Zone zone) {
        ...
        btn.addActionListener(e -> {
            currentZone = zone;
            // Preserve selected seats before changing zone
            ...
            // Restore selected seats for current zone
            for (String seatId : selectedSeats) {
                if (seatId.startsWith(zone.getPrefix())) {
                    seatManager.toggleSeat(seatId);
                }
            }
    ...
    private JPanel createSeatPanel() {
        ...
        legendPanel.add(createLegendItem("Booked", new Color(80, 80, 80)));
